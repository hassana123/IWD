        ...
        <div className="container w-[90%] mx-auto max-w-[900px]">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl font-bold mb-8 text-wtmblue">Get in Touch</h2>
              <form className="space-y-6">
                <div>
                  <label className="block text-gray-700 mb-2">Name</label>
                  <input
                    type="text"
                    className="w-full px-4 py-2 border rounded-lg focus:ring-primary focus:border-primary transition"
                    required
                  />
                </div>
                <div>
            ...
            >
              <div>
                <h2 className="text-3xl font-bold mb-8 text-wtmblue">Contact Information</h2>
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">g3women@gmail.com</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-4 text-wtmblue">Event Location</h2>
